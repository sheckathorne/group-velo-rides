...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "privacy",
                    models.IntegerField(
                        choices=[(5, "Current Members"), (7, "Open")],
                        verbose_name="Privacy",
                    ),
                ),
                ("ride_time", models.TimeField(verbose_name="Ride Time")),
                (
                    "time_zone",
                    models.CharField(
                        choices=[
                ...
                (
                    "drop_designation",
                    models.IntegerField(
                        choices=[(1, "Drop"), (2, "No-Drop")],
                        verbose_name="Drop/No-drop",
                    ),
                ),
                ("max_riders", models.PositiveIntegerField(verbose_name="Max Riders")),
                (
                    "is_canceled",
                ...
                (
                    "frequency",
                    models.IntegerField(
                        choices=[(0, "None"), (1, "Daily"), (7, "Weekly")],
                        verbose_name="Recurrence",
                    ),
                ),
                (
                    "weekdays",
                    group_velo.events.fields.ChoiceArrayField(
        ...
        migrations.CreateModel(
            name="EventOccurenceMemberWaitlist",
            fields=[
                (
                    "id",
                    models.BigAutoField(
                ...
                (
                    "role",
                    models.IntegerField(
                        choices=[(2, "Rider")], default=2, verbose_name="Role"
                    ),
                ),
                (
                    "waitlist_join_date",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "role",
                    models.IntegerField(
                        choices=[(0, "Ride Creator"), (1, "Ride Leader"), (2, "Rider")],
                        default=2,
                        verbose_name="Role",
                    ),
                ),
        ...
        migrations.AddConstraint(
            model_name="eventoccurencememberwaitlist",
            constraint=models.UniqueConstraint(
                fields=("event_occurence", "user"),
                name="eventoccurencememberwaitlist_unique_user",
            ),
        ),
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("event_occurence", "user"),
                name="eventoccurencemember_unique_user",
            ),
        ),
    ]
